const banner = [
  {
    keybanner: "Images/banner1.jpg",
  },
  {
    keybanner: "Images/banner2.jpg",
  },
];
...
const imageicon = [
  {
    keyimagesicon : "Images/facebook.jpg",keylink:[{subkey:"https://www.facebook.com/bizcambo"}]
  },
  {
    keyimagesicon : "Images/twitter.png",keylink:[{subkey:"https://twitter.com/home"}]

  },
  {
    keyimagesicon : "Images/youtube.png",keylink:[{subkey:"https://www.youtube.com/@BusinessCambodiabc"}]
  },
];
...
// var video = [
//   {
//     keyvideo : "Images/vod1.mp4",
//     keycaption: [
//       {
//         subkeycap : "ដាំបន្លែចិញ្ចឹមសត្វជុំវិញផ្ទះ ចំណូលជិត១០០$/ថ្ងៃ | កម្មវិធីកសិកម្ម",
//         keyname : [
//           {
//             subkeyname : "Businisess cambodia",
//             keyveiw : [
//               {
//                 subkeyveiw : "ចំនួននាក់មើល:100ពាន់ .មួយថ្ងៃមុន",
//                 keyvId : [
//                   {
//                     subkeyid : "vid1"
//                   }
...
//   },
//   {
//     keyvideo : "Images/Top CEO.mp4",
//     keycaption: [
//       {
//         subkeycap : "ពីដូនតាមក គេចិញ្ចឹមជ្រូកក្នុងទ្រុង តែគាត់វិញប្រលែងឲ្យស៊ីស្មៅក្នុងរបងឆក់ | កម្មវិធី Top CEO",
//         keyname : [
//           {
//             subkeyname : "Businisess cambodia",
//             keyveiw : [
//               {
//                 subkeyveiw : "ចំនួននាក់មើល:500ពាន់ .1សប្តាហ៍មុន",
//                 keyvId : [
//                   {
//                     subkeyid : "vid2"
//                   }
...
//   },
//   {
//     keyvideo : "Images/កម្មវិធីកសិកម្ម.mp4",
//     keycaption: [
//       {
//         subkeycap : "ក្ដាមស្រែហាក់គ្មានអ្នកចិញ្ចឹមនៅខ្មែរ ខណៈកសិករថៃកំពុងកាក់កបខ្លាំង | Sa Thoura",
//         keyname : [
//           {
//             subkeyname : "Businisess cambodia",
//             keyveiw : [
//               {
//                 subkeyveiw : "ចំនួននាក់មើល​​ 350 ពាន់ .មួយថ្ងៃមុន",
//                 keyvId : [
//                   {
//                     subkeyid : "vid3"
//                   }
...
//   },
//   {
//     keyvideo : "Images/កម្មវិធីក្ដីស្រមៃខ្ញុំ.mp4",
//     keycaption: [
//       {
//         subkeycap : "ធ្វើការឲ្យគេយកជំនាញ មករកស៊ីខ្លួនឯង គួរធ្វើបែបណា? | កម្មវិធីក្ដីស្រមៃខ្ញុំម",
//         keyname : [
//           {
//             subkeyname : "Businisess cambodia",
//             keyveiw : [
//               {
//                 subkeyveiw : "ចំនួននាក់មើល​ 28ពាន់ .2សប្តាហ៍មុន",
//                 keyvId : [
//                   {
//                     subkeyid : "vid4"
//                   }
...
//   },
//   {
//     keyvideo : "Images/យុវជនម្នាក់នេះបោះបង់ប្រាក់ខែខ្ទង់ពាន់ $ មកចិញ្ចឹមបង្កងអូស្រ្តាលីឥទ្បូវបានផលហើយ.mp4",
//     keycaption: [
//       {
//         subkeycap : "ដាំបន្លែចិញ្ចឹមសត្វជុំវិញផ្ទះ ចំណូលជិត១០០$/ថ្ងៃ | កម្មវិធីកសិកម្ម",
//         keyname : [
...
// var getAllItemInVideo = ' ';
// for( let i in video ){
//   var getcaption = ' ';
//   for( let cap of video[i]['keycaption']){
//     getcaption += cap['subkeycap'];
//     for( let vue of ['keyname'[cap]['subkeyname']])
//   }
// } 
...
const locationapp = "https://maps.app.goo.gl/Xpzef7rSFjzaHGzt9"; 
document.getElementsByClassName("location-Main")[0].innerHTML = `<a class="location" href="${locationapp}">Location</a>`;
